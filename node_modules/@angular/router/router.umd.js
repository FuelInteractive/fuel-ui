...
(function (global, factory) {
    ...
    function recognize(componentResolver, type, url) {
        var matched = new _MatchResult(type, [url.root], null, rootNode(url).children, []);
            ...
            if (r.length === 0) {
                ...
                return _recognizeLeftOvers(componentResolver, r[0].component)
                    ...
                    return componentResolver.resolveComponent(r[0].component)
                        .then(function (factory) {
                        var segment = new RouteSegment([], null, DEFAULT_OUTLET_NAME, r[0].component, factory);
    ...
    function _matchWithParts(route, url) {
        ...
        var parameters = StringMapWrapper.merge(isBlank(p) ? {} : p, positionalParams);
    ...
    function _update(node, changes) {
        ...
        if (isBlank(node)) {
            ...
            var urlSegment = isStringMap(segment) ? new UrlSegment(null, segment, null) :
    ...
    var Router = (function () {
        ...
        Router.prototype._createInitialTree = function () {
            var root = new RouteSegment([new UrlSegment("", null, null)], null, DEFAULT_OUTLET_NAME, this._rootComponentType, null);
    ...
    var _UrlParser = (function () {
        ...
        _UrlParser.prototype.parseSegments = function (outletName) {
            ...
            if (isPresent(matrixParams)) {
                ...
                var matrixParamsNode = new TreeNode(matrixParamsSegment, children);
