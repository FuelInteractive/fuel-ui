...
export declare type SubscribableOrPromise<T> = Observablesque<T> | Subscribable<T> | Promise<T>;
export declare type ArrayOrIterable<T> = Iterable<T> | ArrayLike<T>;
export declare type ObservableInput<T> = SubscribableOrPromise<T> | ArrayOrIterable<T>;
/**
