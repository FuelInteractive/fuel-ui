...
var DateRangePicker_Demo_1 = require("./DatePicker/DateRangePicker.Demo");
...
__export(require("./Collapse/Collapse.Demo"));
__export(require("./DatePicker/DatePicker.Demo"));
__export(require("./DatePicker/DateRangePicker.Demo"));
