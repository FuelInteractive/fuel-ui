...
System.registerDynamic("fuel-ui/dist/components/OffCanvasMenu/OffCanvasMenu", ["@angular/core", "@angular/common"], true, function($__require, exports, module) {
  ...
  exports.OFF_CANVAS_MENU_PROVIDERS = [OffCanvasMenu, OffCanvasMenuClose];
  return module.exports;
});
...
System.registerDynamic("fuel-ui/dist/components/components", ["./Accordion/AccordionItem", "./Alert/Alert", "./Carousel/Carousel", "./DatePicker/DatePickerProviders", "./Modal/Modal", "./Pagination/Pagination", "./InfiniteScroller/InfiniteScroller", "./Dropdown/Dropdown", "./Tab/Tab", "./Tag/Tag", "./TableSortable/TableSortable", "./Slider/Slider", "./TimePicker/TimePicker", "./TextExpander/TextExpander", "./OffCanvasMenu/OffCanvasMenu", "./Accordion/Accordion", "./Tab/TabSet", "./TableSortable/TableSortableColumn", "./TableSortable/TableSortableSorting", "./Tag/TagSet"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
